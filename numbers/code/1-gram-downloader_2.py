...
# Diccionarios del sistema numérico mayor invertido separados por longitudes de claves en español
major_system_3_chars_es = {
    'cha': '6', 'che': '6', 'chi': '6', 'cho': '6', 'chu': '6',
    'sha': '6', 'she': '6', 'shi': '6', 'sho': '6', 'shu': '6',
    #'exi':'6',# mexico, ex una excepcion exiliado
}

major_system_2_chars_es = {
    'rr': '4', 'wa': '6',#waterpolo
...
# Diccionarios del sistema numérico mayor invertido separados por longitudes de claves en inglés
major_system_3_chars_en = {
    'cha': '6', 'che': '6', 'chi': '6', 'cho': '6', 'chu': '6',
    'sha': '6', 'she': '6', 'shi': '6', 'sho': '6', 'shu': '6'
}

major_system_2_chars_en = {
    'ck': '7',# check this one first
    'sa': '0', 'se': '0', 'si': '0', 'so': '0', 'su': '0',
    'za': '0', 'ze': '0', 'zi': '0', 'zo': '0', 'zu': '0',
    'ta': '1', 'te': '1', 'ti': '1', 'to': '1', 'tu': '1',
    'da': '1', 'de': '1', 'di': '1', 'do': '1', 'du': '1',
    ...
    'qa': '7', 'qe': '7', 'qi': '7', 'qo': '7', 'qu': '7',
    'fa': '8', 'fe': '8', 'fi': '8', 'fo': '8', 'fu': '8',
    'va': '9', 've': '9', 'vi': '9', 'vo': '9', 'vu': '9',
    'pa': '9', 'pe': '9', 'pi': '9', 'po': '9', 'pu': '9',
    'ba': '9', 'be': '9', 'bi': '9', 'bo': '9', 'bu': '9'
}

major_system_1_char_en = {
    's': '0', 'z': '0',
    't': '1', 'd': '1',
    'n': '2',
    'm': '3',
...
def convertir_a_numeros(palabra, idioma='spa'):
    ...
    if idioma == 'spa':
        ...
        major_system_3_chars = major_system_3_chars_es
        major_system_2_chars = major_system_2_chars_es
        major_system_1_char = major_system_1_char_es
    elif idioma == 'eng':
        major_system_3_chars = major_system_3_chars_en
        major_system_2_chars = major_system_2_chars_en
        major_system_1_char = major_system_1_char_en
    else:
        raise ValueError("Idioma no soportado. Use 'es' para español o 'en' para inglés.")
...
# Ejemplo de uso
print(convertir_a_numeros('chaqueta', 'spa'))  # Debería imprimir '671'
print(convertir_a_numeros('jacket', 'eng'))    # Debería imprimir '671'
        ...
        try:
            with open(file_n, 'ab') as f:
                for record in tqdm(records):
                    w = record.ngram
                    #print(record.year)
                    if record.year!=2000 or record.match_count<100:
                        continue
                    #else:
                    #    print(".")
                    if len(w)>4 and w[-4:]=='NOUN':
                        palabra = record.ngram[:-5]
                        cad = palabra + ", "+str(record.match_count)+ ", "+convertir_a_numeros(palabra,lang)+"\n"
